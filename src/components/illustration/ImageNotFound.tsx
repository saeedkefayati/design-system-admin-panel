    ...
    >
      <g id="freepik--background-complete--inject-14">
        <rect
          ...
          width="500"
          height="0.25"
          fill={dark ? theme.colors.gray[2] : theme.colors.gray[8]}
        ></rect>
        <rect
          x="428.22"
          y="398.49"
        ...
        <polygon
          ...
          fill={dark ? theme.colors.gray[1] : theme.colors.gray[7]}
        />
        <path
        ...
        <path
          ...
          fill={dark ? theme.colors.gray[0] : theme.colors.gray[6]}
        />
        <polygon
      ...
      <g id="freepik--oops--inject-14">
        <path
          ...
          fill={dark ? theme.colors.gray[6] : theme.colors.gray[5]}
        />
        <path
      ...
      <g id="freepik--Character--inject-14">
        <path
          ...
          fill={dark ? theme.colors.gray[6] : theme.colors.gray[5]}
        />
        <circle cx="251.51" cy="273" r="18.38" fill="#fff" />
        <path
        ...
        <path
          ...
          fill={dark ? theme.colors.gray[6] : theme.colors.gray[5]}
        />
        <circle cx="209.88" cy="297.88" r="0.82" fill={dark ? theme.colors.gray[6] : theme.colors.gray[5]} />
        <path
